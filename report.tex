...
Some sample results can be seen in Fig X (TODO add fig).

The model achieved an mAP of 86 on an unseen subset of the internal dataset given to us by CDAC, and an mAP of 81 on the KITTI dataset. The precision recall curves can be seen in Figs. wtvr
...
The model achieved an mAP of 95.8 on an unseen subset of the internal dataset given to us by CDAC, and an mAP of 68.31 on the KITTI dataset. The precision recall curves can be seen in Figs. 5 and 6.
