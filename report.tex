...
\item Localization Loss: This measures the errors in the predicted boundary box locations and sizes. The formula is as defined below: TODO EQUATION

\item Confidence Loss: If an object is detected in the box, the confidence loss is as defined below: TODO EQUATION
    
\end{enumerate}

The final loss is the sum of these three parts.
